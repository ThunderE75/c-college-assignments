//t Deletion in Binary Search Tree
//* Refrence: https://www.javatpoint.com/program-to-construct-a-binary-search-tree-and-perform-deletion-and-inorder-traversal
#include <stdio.h>  
#include <stdlib.h>  
#include <stdbool.h>
#include <conio.h>
